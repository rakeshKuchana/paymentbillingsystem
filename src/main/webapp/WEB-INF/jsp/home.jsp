    ...
    <head>
        ...
        <script>
            ...
            function sendInfo()
            {
                ...
                var url = "/paymentbillingsystem/student/findname?val=" + v;
            ...
            {
                var v = name;
                var url = "/paymentbillingsystem/student/getgeninfo?val=" + v;
                if (window.XMLHttpRequest) {
                    request = new XMLHttpRequest();
                } else if (window.ActiveXObject) {
                    request = new ActiveXObject("Microsoft.XMLHTTP");
            ...
            {
                var v = name;
                var url = "/paymentbillingsystem/student/viewall?val=" + v;
            ...
            {
                var v = name;
                var url = "/paymentbillingsystem/student/viewallinfo?val=" + v;
