    ...
    <head>
        ...
        <script>
            ...
            function sendInfo()
            {
                ...
                var url = "/paymentbillingsystem/student/findname1?val=" + v;
            ...
            {
                var v = name;
                var url = "/paymentbillingsystem/student/getgeninfoname?val=" + v;
                if (window.XMLHttpRequest) {
                    request = new XMLHttpRequest();
                } else if (window.ActiveXObject) {
                    request = new ActiveXObject("Microsoft.XMLHTTP");
    ...
    <div id="outer">
        ...
        <body>
            ...
            <div id="box">
                ...
                <form action="/paymentbillingsystem/student/save1" name="myform" id="hello" method="post">
                    <table width="100%">
                        <tr>
