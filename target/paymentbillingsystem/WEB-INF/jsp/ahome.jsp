    ...
    <head>
        ...
        <script>
            ...
            function sendInfo()
            {
                ...
                var url = "/paymentbillingsystem/payregister/afindname?val=" + v + "&branch=" + branch;
            ...
            {
                var v = name;
                var url = "/paymentbillingsystem/payregister/aviewall?val=" + v;
                ...
                <div id="box">
                    ...
                    <form name="myform" >
                        ...
                        <div id="right" align="right">
                            <a href="/paymentbillingsystem/create"><font style="color: navy;"><B>Create New Accountant</B></font></a>
                        </div>
