        ...
        <body width="100">
            ...
            <div id="main">
                ...
                <div id="box">
                    ...
                    <form:form action="/paymentbillingsystem/student/register" modelAttribute="studentRegistrationForm" method="post">
                        <table width="100%">
                            <tr>
                                <td><table width="55%" align="left" style="table-layout: fixed;">
                                        <tr><td>
                                                <table cellspacing=15 cellpadding=15">
                                                    ...
                                                    <tr><td><B>Trainer:</B></td><td><form:input type="text" path="trainer"/></td></tr>
